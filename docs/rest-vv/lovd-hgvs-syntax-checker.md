...
If the LOVD HGVS Syntax Checker contributes to your research, software, or publication, please cite the LOVD project.
...
If VariantValidator also contributes to your work through its integration of the LOVD HGVS Syntax Checker or other functionality, please also cite the appropriate VariantValidator publication(s).
