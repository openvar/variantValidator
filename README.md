...
[![Build Status](http://127.0.0.1:8080/buildStatus/icon?job=VariantValidator+CI%2F${BRANCH_NAME})](http://127.0.0.1:8080/job/VariantValidator%20CI/job/${BRANCH_NAME}/)
