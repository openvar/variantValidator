        ...
        stage("Build and Run SeqRepo") {
            steps {
                script {
                    ...
                    seqRepoContainer.run("--network $DOCKER_NETWORK --privileged -v /var/jenkins_home/workspace/VariantValidator_ci/variantvalidator_data/share:/usr/local/share:rw,rec -v /var/jenkins_home/workspace/VariantValidator_ci/variantvalidator_data/share/seqrepo:/usr/local/share/seqrepo:rw,rec -v /var/jenkins_home/workspace/VariantValidator_ci/variantvalidator_data/share/logs:/usr/local/share/logs:rw,rec")
        ...
        stage("Build and Run VariantValidator") {
            steps {
                script {
                    ...
                    variantValidatorContainer.run("--privileged -v /var/jenkins_home/workspace/VariantValidator_ci/variantvalidator_data/share:/usr/local/share:rw,rec -v /var/jenkins_home/workspace/VariantValidator_ci/variantvalidator_data/share/logs:/usr/local/share/logs:rw,rec -v /var/jenkins_home/workspace/VariantValidator_ci/variantvalidator_data/share/seqrepo:/usr/local/share/seqrepo:rw,rec -d --name variantvalidator-${CONTAINER_SUFFIX} --network $DOCKER_NETWORK")
