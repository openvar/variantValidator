        ...
        stage("Build and Run SeqRepo") {
            steps {
                script {
                    ...
                    seqRepoContainer.run("--network $DOCKER_NETWORK -v /var/jenkins_home/workspace/VariantValidator_ci/variantvalidator_data/share:/usr/local/share:rw -v /var/jenkins_home/workspace/VariantValidator_ci/variantvalidator_data/share/seqrepo:/usr/local/share/seqrepo:rw -v /var/jenkins_home/workspace/VariantValidator_ci/variantvalidator_data/share/logs:/usr/local/share/logs:rw")
        ...
        stage("Build and Run VariantValidator") {
            steps {
                script {
                    ...
                    variantValidatorContainer.run("-v /var/jenkins_home/workspace/VariantValidator_ci/variantvalidator_data/share:/usr/local/share:rw -v /var/jenkins_home/workspace/VariantValidator_ci/variantvalidator_data/share/logs:/usr/local/share/logs:rw -v /var/jenkins_home/workspace/VariantValidator_ci/variantvalidator_data/share/seqrepo:/usr/local/share/seqrepo:rw -d --name variantvalidator-${CONTAINER_SUFFIX} --network $DOCKER_NETWORK")
