...
class Mixin(vvMixinInit.Mixin):
    ...
    def myevm_t_to_g(self, hgvs_c, evm, hdpOld, primary_assembly):
        # create no_norm_evm
        ...
        try:
            ...
            self.hn.normalize(hgvs_genomic) # Check the validity of the mapping
    ...
    def myevm_g_to_t(self, hdpOld, evm, hgvs_genomic, alt_ac):
    ...
    def merge_hgvs_3pr(self, hgvs_variant_list):
        ...
        for hgvs_v in hgvs_variant_list:
            ...
            hgvs_v = self.hn.normalize(hgvs_v)
        ...
        try:
            hgvs_delins = self.hn.normalize(hgvs_delins)
    ...
    def merge_pseudo_vcf(self, vcf_list, genome_build):
        hgvs_list = []
