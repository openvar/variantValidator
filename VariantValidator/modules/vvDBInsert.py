from vvDatabase import handleCursor
...
class vvDBInsert:
    ...
    def insert_refSeqGene_data(self,rsg_data):
        ...
        self.cursor.execute(query, (rsg_data[0], rsg_data[1], rsg_data[2], rsg_data[3], rsg_data[4], rsg_data[5], rsg_data[6], rsg_data[7], rsg_data[8], rsg_data[9], rsg_data[10]))
        # Query report
        if self.cursor.lastrowid:
            success = 'true'
        else:
    ...
    def insert_LRG_transcript_data(self,lrgtx_to_rstID):
        ...
        self.cursor.execute(query, (lrgtx_to_rstID[0], lrgtx_to_rstID[1]))
        # Query report
        if self.cursor.lastrowid:
            success = 'true'
        else:
