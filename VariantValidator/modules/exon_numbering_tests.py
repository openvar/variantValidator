...
if (test_1['NC_000017.10']['start_exon'] != '14' and
        test_1['NG_005905.2']['end_exon'] != '10'):
...
if (test_2['NC_000017.10']['start_exon'] != '44i'
        and test_2['NG_007400.1']['end_exon'] != '8i'):
...
if (test_3['NC_000003.11']['start_exon'] != '32i'
        and test_3['NG_007065.1']['end_exon'] != '85i'):
    print("Failed: test variant 3")
    print("Output dictionary: ")
    print(test_3)

test_4 = finds_exon_number(test_variant_4)
if (test_4['NC_000017.10']['start_exon'] != '44' and
        test_4['NG_007400.1']['end_exon'] != '8'):
    print("Failed: test variant 4")
    print("Output dictionary: ")
    print(test_4)

test_5 = finds_exon_number(test_variant_5)
if (test_5['NC_000017.10']['start_exon'] != '44' and
        test_5['NG_007400.1']['end_exon'] != '8'):
    print("Failed: test variant 5")
    print("Output dictionary: ")
    print(test_5)

test_6 = finds_exon_number(test_variant_6)
if (test_6['NC_000003.11']['start_exon'] != '32i' and
        test_6['NC_000003.11']['end_exon'] != '33'):
