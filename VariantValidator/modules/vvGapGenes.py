"""
GapGenes contains a list of genes for which tere are instances where there is a discrepancy in the transcipt exon and
the equivalent alighed genome exon. This is only relevant to RefSeq and only in instances of the following blacklisted
genes
"""
