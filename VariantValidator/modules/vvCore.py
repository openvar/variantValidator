                    ...
                    if re.search('\w+\:[gcnmrp]', input) and not re.search('\w+\:[gcnmrp]\.', input):
                        ...
                        try:
                            ...
                            if not re.match('N[CGTWMRP]_', input) and not re.match('LRG_', input):
                                ...
                                accession = vvChromasomes.to_accession(chr_num, selected_assembly)
                ...
                if (type == ':g.'):
                    ...
                    if len(rel_var) == 0:
                        ...
                        # Chromosome build is not supported or intergenic???
                            ...
                            sfm = vvChromasomes.supported_for_mapping(hgvs_genomic.ac, primary_assembly)
                            if sfm == 'true':
                                try:
                    ...
                    if len(multi_gen_vars) != 0:
                        for alt_gen_var in multi_gen_vars:
                            for build in self.genome_builds:
                                test = vvChromasomes.supported_for_mapping(alt_gen_var.ac, build)
                                if test == 'true':
                                    try:
