...
def transcripts_to_gene(variant, validator):
    ...
    obj = validator.hp.parse_hgvs_variant(str(variant.quibble))
    ...
    # If cck not true
        ...
        hgvs_rna_input = validator.hp.parse_hgvs_variant(
            variant.trapped)  # Traps the hgvs variant of r. for further use
    ...
    if valid == 'false':
        ...
        genomic_validation = str(
            validator.genomic(input, variant.no_norm_evm, variant.primary_assembly,variant.hn) )
